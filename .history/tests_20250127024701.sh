...
echo "Running Test 2"
actual_output=$(echo -e "200, 10" | ./rod_cutting 100 | tr -d '\r')

expected_output=$(echo -e "Enter piece prices in the format <length>, <value> (press Ctrl+Z to end input):\nRemainder: 100\nValue: 0\n")
